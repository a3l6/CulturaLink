...
def classify(texts: str) -> bool:
    ...
    response = co.classify(
        ...
        examples=[Example("I hate black people", "Unacceptable"),
                  Example("The Holocaust needs to be repeated", "Unacceptable"), Example(
            "I love flowers", "Acceptable"),
            Example("I don\'t like vegetables", "Acceptable"),
            Example("Mexican people are the worst", "Unacceptable"),
            Example("I\'m going on a walk today", "Acceptable"), Example(
            "Im gonna kill you", "Unacceptable"),
            Example("I hate all jews", "Unacceptable"), Example(
            "Kill yourself", "Unacceptable"),
            Example("I\'m gonna kill everybody", "Unacceptable"),
            Example("Fucking shit you stupid asshole", "Unacceptable"), Example(
            "I don\'t like tacos", "Acceptable"),
            Example("I don\'t like beaners", "Unacceptable"), Example(
            "Fuck UOFT", "Unacceptable"),
            Example("Bitch ass", "Unacceptable"), Example(
            "Go back to your country", "Unacceptable"),
            Example("I don\'t like milk", "Acceptable"), Example(
            "I don\'t like apples", "Acceptable"),
            Example("I like apples", "Acceptable"), Example(
            "I hate bananas", "Acceptable"),
            ...
            Example("I hate [ethnicity/religious group] because they\'re all criminals and should be deported!",
                    "Unacceptable"),
            Example(
            "Women belong in the kitchen, not in positions of power", "Unacceptable"),
            Example(
            "People with disabilities are a burden on society and should be euthanized", "Unacceptable"),
            Example("LGBTQ+ individuals are unnatural and should be \'fixed\' through conversion therapy.",
                    "Unacceptable"),
            Example(
            "All Muslims are terrorists and should be banned from entering our country", "Unacceptable"),
            Example("Jews control the media and the economy, spreading lies and manipulating society.",
                    "Unacceptable"),
            Example(
            "Black people are lazy and only want handouts from the government", "Unacceptable"),
            Example("Transgender people are mentally ill and should be treated as such, not encouraged",
                    "Unacceptable"),
            Example(
            "Indigenous people are primitive and should assimilate into modern society", "Unacceptable"),
            Example(
            "Refugees are invaders who will bring crime and disease to our country", "Unacceptable"),
            Example(
            "Fat people are disgusting and should be shamed into losing weight", "Unacceptable"),
            ...
            Example("I don\'t like horror movies.", "Acceptable"), Example(
            "I don\'t like olives.", "Acceptable"),
            Example("I don\'t  like curry", "Acceptable"), Example("I immigrated from a country", "Acceptable")])
    # print('The confidence levels of the labels are: {}'.format(response.classifications))
    print(f"{texts, response.classifications}")
    if response.classifications[0].predictions[0] == "Acceptable":
        return False
    return True
